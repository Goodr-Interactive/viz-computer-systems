...
export const LinearFalseSharingViz: React.FC = () => {
  ...
  // Re-randomize when words per line changes
  useEffect(() => {
    ...
    <div id="linear-false-sharing-container" className="mx-auto w-full max-w-5xl p-4">
      ...
      <div className="mt-6 rounded-lg border border-yellow-200 bg-yellow-50 p-4">
        ...
        <div className="mt-2 text-sm text-yellow-600">
          <strong>Total Memory:</strong> {TOTAL_WORDS} words | <strong>Cache Line Size:</strong> {wordsPerLine} words per line | <strong>Total Lines:</strong> {TOTAL_LINES} lines
        </div>
        {scenario !== "no-sharing" && (
