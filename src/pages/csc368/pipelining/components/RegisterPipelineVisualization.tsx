...
export const RegisterPipelineVisualization: React.FC<RegisterPipelineVisualizationProps> = ({
  ...
  const RegisterPipelineTooltip = () => {
    ...
    const tooltipHeight = instruction?.stalled ? 130 : 110;
    ...
    const getSmartPosition = () => {
      ...
      if (tooltip.x + defaultOffsetX + tooltipWidth > availableWidth) {
        // Tooltip would extend beyond right edge, position to the left
        adjustedX = tooltip.x - tooltipWidth - defaultOffsetX;
        ...
        adjustedX = tooltip.x + defaultOffsetX;
      }
      
      // Check vertical bounds
      if (tooltip.y + defaultOffsetY - tooltipHeight < 0) {
        // Tooltip would extend beyond top edge, position below
        adjustedY = tooltip.y + Math.abs(defaultOffsetY) + 20; // Add some padding
        ...
        adjustedY = tooltip.y + defaultOffsetY;
      }
