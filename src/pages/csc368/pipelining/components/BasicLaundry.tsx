        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              <strong>Laundry Efficiency:</strong> In {isPipelined ? "pipelined" : "non-pipelined"}{" "}
              ...
              {isPipelined ? (
                <>
                  {" "}
                  With pipelined laundry, you can complete a load every 30 minutes once the pipeline
                  is full, achieving a CPI of 1.0. Without pipelining, each load would take all{" "}
                  {PIPELINE_STAGES.length} stages to complete before starting the next.
                </>
              ) : (
                <>
                  {" "}
